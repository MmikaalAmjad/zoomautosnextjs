...
<option value="ANY" >ANY</option>
   ...
   />
     ...
     <div className="form-group" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
       <label htmlFor="fromTime" style={{ marginRight: '10px' }}>From Time:</label>
       <select
         id="fromTime"
         name="fromTime"
         value={formData.fromTime}
   ...
   <option value="Anytime">Anytime</option>
       ...
       <div style={{ display: 'flex', alignItems: 'center' }}>
         ...
         />
         <label htmlFor="specificFromTime" style={{ marginLeft: '5px' }}>Specific Date</label>
       </div>
     </div>
   
     {/* To Time Section */}
     <div className="form-group" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
       <label htmlFor="toTime" style={{ marginRight: '10px' }}>To Time:</label>
       <select
         id="toTime"
         name="toTime"
         value={formData.toTime}
       ...
       <div style={{ display: 'flex', alignItems: 'center' }}>
         ...
         />
         <label htmlFor="specificToTime" style={{ marginLeft: '5px' }}>Specific Date</label>
       </div>
     </div>
   </div>

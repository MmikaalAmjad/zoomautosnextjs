...
const RecordFormPending = () => {
  ...
  const [record, setRecord] = useState(null);
    ...
    // const handleReturnVehiclesInputChange = (e, index) => {
    //   const { name, value } = e.target;
    ...
    //   });
    // };
    // const handleVehiclesInputChange = (e, index) => {
    //   const { name, value } = e.target;
        ...
        {formData.servicetype==="MULTI DROP OFF" &&(
            <>
             ...
             <div className="form-group">
                     ...
                     <select id="roadworthy" name="roadworthy" value={formData.roadworthy}  disabled required>
         ...
         <option value="no">No</option>
                   ...
                   <div className="form-group">
                     ...
                     <select id="fuel" name="fuel" value={formData.fuel}  disabled required>
                     <option value="" disabled selected hidden>
                     Fuel Required?
           </option>
         <option value="yes">Yes</option>
         <option value="no">No</option>
            ...
            <div className="form-group">
              ...
              <select id="movement" name="movement" value={formData.movement}  disabled required>
              <option value="" disabled selected hidden>
              Movement Type?
    </option>
...
<option value="OTHERS" >OTHERS</option>
            ...
            <div className="form-group">
              ...
              <select id="service" name="service" value={formData.service}  disabled  required>
              <option value="" disabled selected hidden>
              Service Type?
    </option>
...
<option value="ANY" >ANY</option>
  ...
  <option value="no">No</option>
    ...
    <div className='form-row'>
            <div className="form-group">
              <label htmlFor="movement">Movement Type?</label>
              <select id="movement" name="movement" value={formData.movement}  disabled onChange={handleChange} required>
              <option value="" disabled selected hidden>
              Movement Type?
    </option>
    <option value="INTERNAL TRANSFER">INTERNAL TRANSFER</option>
...
<option value="OTHERS" >OTHERS</option>
            ...
            <div className="form-group">
              <label htmlFor="service">Service Type?</label>
              <select id="service" name="service" value={formData.service}   disabled onChange={handleChange} required>
              <option value="" disabled selected hidden>
              Service Type?
    </option>
    <option value="DRIVEN">DRIVEN</option>
...
{formData.carType==="New Car" &&(
      ...
      <div className="form-row">
        ...
        <div className="form-group">
          <label htmlFor="dropoffCity">Town/City:</label>
          <input
            type="text"
            id="dropoffCity"
            name="dropoffCity"
...
/>
  ...
  <button className='contact-button' onClick={handleSubmit}>Confirm Change
...
export default RecordFormPending;
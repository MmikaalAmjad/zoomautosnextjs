...
import { useAdminJobListener } from '@/app/hooks/joblistener';
import { FaEye } from 'react-icons/fa';

const RecordListPending = () => {
...
// ✅ Run fetchRecords when token changes
useEffect(() => {
  if (token) {
    fetchRecords();
  }
  ...
  useAdminJobListener(fetchRecords)
  ...
  useEffect(() => {
    if (!jobId) {
      ...
      const matchingJobs = uniqueJobIds.filter((id:any) => id.includes(jobId));
...
export default RecordListPending;